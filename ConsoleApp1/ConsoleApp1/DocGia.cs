  ...
  public  class DocGia:Nguoi
    {
        ...
        public DocGia(string madg, string hoten, string diachi, string sdt, string ngaysinh, string email, int ngay, int thang, int nam,int taikhoan)
        {
        ...
        public  void nhap(string madg, string hoten, string diachi, string sdt, string email, string ngaysinh, int ngay, int thang, int nam,int taikhoan)
        {
            base.nhap(hoten, diachi, sdt, ngaysinh);
            this.MaDG = madg;
            this.Email = email;
